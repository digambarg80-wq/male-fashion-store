...
// Get category name
$cat_stmt = $pdo->query("SELECT name FROM categories WHERE id = 4");
$category = $cat_stmt->fetch();
?>

<style>
.category-hero {
    background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://images.pexels.com/photos/260082/pexels-photo-260082.jpeg');
